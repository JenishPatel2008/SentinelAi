...
def calculate_threat(objects, intrusion_duration=0, config=None, plate_matches=None, night_movements=None, behaviors=None):
    ...
    if not intruders:
        ...
        if night_movements:
            ...
            return {"score": 20, "severity": "LOW", "reason": f"Night-time movement: {object_name} moving during {condition} conditions", "watchlist_matches": [], "behaviors": [], "behavior_reasons": []}
        return {"score": 0, "severity": "LOW", "reason": "No restricted-zone intrusion", "behaviors": [], "behavior_reasons": []}
    ...
    return {"score": score, "severity": severity, "reason": reason, "watchlist_matches": plate_matches, "behaviors": behavior_types, "behavior_reasons": behavior_reasons}
