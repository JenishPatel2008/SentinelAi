...
def ensure_compatibility_columns():
    ...
    additions = {
        ...
        "alerts": {"camera_id": "INTEGER", "track_id": "INTEGER", "object_type": "VARCHAR(50)", "zone": "VARCHAR(100)", "zone_type": "VARCHAR(30)", "score": "INTEGER", "reason": "TEXT", "evidence_path": "VARCHAR(500)", "timestamp": "DATETIME", "plate_number": "VARCHAR(20)", "plate_confidence": "FLOAT", "plate_observation_id": "INTEGER", "watchlist_match": "BOOLEAN DEFAULT 0", "watchlist_label": "VARCHAR(100)", "scene_condition": "VARCHAR(20)", "night_confidence": "FLOAT", "movement_distance": "FLOAT", "vehicle_class": "VARCHAR(30)", "vehicle_class_confidence": "FLOAT"},
        "events": {"type": "VARCHAR(100)", "plate_number": "VARCHAR(20)", "plate_confidence": "FLOAT", "watchlist_match": "BOOLEAN DEFAULT 0", "track_id": "INTEGER", "object_type": "VARCHAR(50)", "zone": "VARCHAR(100)", "zone_type": "VARCHAR(30)", "scene_condition": "VARCHAR(20)", "night_confidence": "FLOAT", "movement_distance": "FLOAT", "duration_seconds": "FLOAT", "evidence_path": "VARCHAR(500)", "vehicle_class": "VARCHAR(30)", "vehicle_class_confidence": "FLOAT"},
    }
