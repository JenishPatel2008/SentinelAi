...
def ensure_compatibility_columns():
    ...
    additions = {
        ...
        "events": {"type": "VARCHAR(100)", "plate_number": "VARCHAR(20)", "plate_confidence": "FLOAT", "watchlist_match": "BOOLEAN DEFAULT 0", "track_id": "INTEGER", "object_type": "VARCHAR(50)", "zone": "VARCHAR(100)", "zone_type": "VARCHAR(30)", "scene_condition": "VARCHAR(20)", "night_confidence": "FLOAT", "movement_distance": "FLOAT", "duration_seconds": "FLOAT", "evidence_path": "VARCHAR(500)", "vehicle_class": "VARCHAR(30)", "vehicle_class_confidence": "FLOAT", "behavior_type": "VARCHAR(50)", "behavior_state": "VARCHAR(30)", "behavior_reason": "TEXT", "behavior_metadata": "TEXT"},
    }
