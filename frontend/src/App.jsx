...
import { API_BASE_URL, acknowledgeAlarm, createCamera, createTrustedPerson, decideAlert, deleteCamera, deleteTrustedPerson, getAlarm, getAlert, getAlerts, getAnalytics, getCameras, getCamerasWithStatuses, getCurrentUser, getDetections, getEvents, getHealth, getIncidents, getPlateHistory, getSettings, getStreamPreviewUrl, getStreamStatus, getTrustedPersons, loginOperator, logoutOperator, replaceTrustedPersonReference, silenceAlarm, startStream, stopStream, testRtspConnection, updateCamera, updateIncident, updateSettings, updateTrustedPerson, uploadVideo } from "./services/api";
import "./App.css";
import ZoneEditor from "./components/zones/ZoneEditor";
import useWebSocket from "./hooks/useWebSocket";

const nav = [["Dashboard", "/dashboard", LayoutDashboard], ["Live Monitoring", "/monitoring", Video], ["Alerts", "/alerts", Bell], ["Analytics", "/analytics", BarChart3], ["Archive", "/events", Activity], ["Plate History", "/plate-history", Search], ["Cameras", "/cameras", Camera], ["Border Map", "/border-map", Map], ["Trusted Persons", "/trusted-persons", Shield], ["Incidents", "/incidents", AlertTriangle], ["Settings", "/settings", Settings]];
